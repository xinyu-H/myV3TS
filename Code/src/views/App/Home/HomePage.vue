<template>
    <div class="HomePage padding">
        ...
        <van-overlay :show="isShowFireworkOverlay" @click="isShowFireworkOverlay = false" class="fireworkOverlay"></van-overlay>
        <van-overlay :show="isShowSignOverlay" @click.self="isShowSignOverlay = false" class="SignOverlay padding">
            <!-- 签名 -->
